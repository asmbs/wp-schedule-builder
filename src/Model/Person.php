 ...
 */
class Person extends AbstractModel implements \JsonSerializable
{
    /** @var  string */
    protected $prefix;
    ...
    public function jsonSerialize(): array
    {
        return array_merge(
            ...
            array_filter([
                ...
                'first_name' => html_entity_decode(trim($this->getFirst())),
                'middle_name' => html_entity_decode(trim($this->getMiddle())),
                'last_name' => html_entity_decode(trim($this->getLast())),
                'suffix' => html_entity_decode(trim($this->getSuffix())),
                'credentials' => $this->getCredentials(),
                'organization' => html_entity_decode(trim($this->getOrganization())),
